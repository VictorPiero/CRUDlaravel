...
<form class="max-w-xl px-8 py-4 mx-auto bg-white rounded shadow dark:bg-slate-800" action="{{route('login')}}" method="POST">
    ...
    <div class="space-y-4">
        ...
        <label class="flex items-center">
            <input class="border rounded dark:bg-slate-900 dark:focus:ring-slate-800 focus:ring-opacity-50" 
            name="remember" 
            type="checkbox" >
    ...
    <div class="flex items-center justify-between mt-4">
        ...
        <a class="text-sm font-semibold underline border-2 border-transparent rounded dark:text-slate-300 text-slate-600 focus:border-slate-500 focus:outline-none" href="{{ route('register')}}">Registrar</a>
